...
## Pre-fix Research
```bash
python3 %USERPROFILE%/.claude/skills/ui-ux-pro-max/scripts/search.py "<product-type>" --domain product
python3 %USERPROFILE%/.claude/skills/ui-ux-pro-max/scripts/search.py "<style>" --domain style
python3 %USERPROFILE%/.claude/skills/ui-ux-pro-max/scripts/search.py "accessibility" --domain ux
```
