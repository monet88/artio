...
class _$GenerationJobModelImpl implements _GenerationJobModel {
  ...
  @override
  String toString() {
    return 'GenerationJobModel(id: $id, userId: $userId, templateId: $templateId, prompt: $prompt, status: $status, aspectRatio: $aspectRatio, imageCount: $imageCount, resultUrls: $resultUrls, errorMessage: $errorMessage, createdAt: $createdAt, completedAt: $completedAt)';
  }
