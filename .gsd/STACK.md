...
|---------|----------|---------|--------|
| Auth | Supabase Auth | Email/password authentication | ✅ Active |
| Database | Supabase (Postgres) | Templates, profiles, generation_jobs, user_credits, credit_transactions, ad_views | ✅ Active |
| Object Storage | Supabase Storage | Generated images (bucket: `generated-images`) | ✅ Active |
| Edge Functions | Supabase (Deno) | generate-image, reward-ad, revenuecat-webhook | ✅ Active |
| AI Generation (primary) | KIE.ai | Imagen4, Imagen4-Fast, Imagen4-Ultra, Nano-Banana, Flux-2, GPT Image, Seedream | ✅ Active |
| AI Generation (secondary) | Google Gemini | gemini-3-pro-image-preview, gemini-2.5-flash-image | ✅ Active |
| Error Tracking | Sentry | Production crash reporting | ✅ Active |
| In-App Purchases | RevenueCat | iOS/Android subscriptions (Pro: 200 credits/mo, Ultra: 500 credits/mo) | ✅ Implemented |
| Rewarded Ads | Google AdMob | Mobile rewarded interstitials (5 credits/ad, 10 ads/day max) | ✅ Implemented |
| Payments (Web) | Stripe | Web payments | 🔜 Planned |
...
| flutter test | `flutter test` | Run unit + widget tests (88 test files, 651 tests) |
...
| deno check | `deno task check` | Type-check all 5 Edge Function files — 0 issues ✅ |
