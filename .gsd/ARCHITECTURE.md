...
> Auto-generated by /map on 2026-02-19 (updated 2026-02-19T18:31)
...
- [x] ~~**Deprecated Riverpod Ref types**~~ — Fixed in Code Health milestone (all providers use `Ref`)
- [x] ~~**Admin web dart:io usage**~~ — Fixed in Code Health milestone (removed from error_state_widget)
