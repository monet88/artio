...
```
artio/
├── lib/                      # Main app source code (194 files total: 145 source + 49 generated, ~13,248 LoC)
...
│   │   └── utils/            # AppExceptionMapper, EmailValidator, Retry, DateTimeUtils, WatermarkUtil
...
├── test/                     # 76 unit + widget test files (mirrors lib/ structure)
...
- Static analysis: `flutter analyze` — 1 warning (`prefer_const_declarations` in test file, non-blocking)
