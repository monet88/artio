...
class GalleryItemFixtures {
  ...
  static GalleryItem single({
    ...
    imageUrl:
        imageUrl ??
        'https://storage.example.com/images/${DateTime.now().millisecondsSinceEpoch}.png',
  ...
  static GalleryItem completed({String? id, String? imageUrl}) =>
      GalleryItemFixtures.single(
        id: id,
        imageUrl:
            imageUrl ?? 'https://storage.example.com/images/completed.png',
  ...
  static GalleryItem failed({String? id}) =>
      GalleryItemFixtures.single(id: id, status: GenerationStatus.failed);

  /// Creates a processing gallery item
  static GalleryItem processing({String? id}) =>
      GalleryItemFixtures.single(id: id, status: GenerationStatus.processing);
  ...
  static GalleryItem deleted({String? id}) =>
      GalleryItemFixtures.completed(id: id).copyWith(deletedAt: DateTime.now());

  /// Creates a list of gallery items
  static List<GalleryItem> list({int count = 10}) => List.generate(count, (i) {
    final statuses = [
